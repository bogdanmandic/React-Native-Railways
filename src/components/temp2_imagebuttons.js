                    ...
                    <View style={styles.contentContainer}>
                        ...
                        <View style={styles.contentPic}>
                            ...
                            <LightBox style={{width: '100%', height: '100%', }}>
                              <Image resizeMethod='resize' style={{width: '100%', height: '100%', resizeMode: 'contain'}} source={{ uri: this.props.files.find(file => file.substring(file.length - 3, file.length) == 'jpg' || file.substring(file.length - 3, file.length) == 'png') }}/>
                            </LightBox>
